...
func main() {
	...
	//request.Header.Set("Accept", "application/xml") --> "Unsupported 'Accept' header: 'application/xml'
...
- refer next program -- basically HTTP client as seperate package library needs to be built
*/
